...
@objc public enum PermissionType: Int, CustomStringConvertible {
    case contacts, notifications, microphone, camera, photos, reminders, events
    ...
    static let allValues = [contacts, notifications, microphone, camera, photos, reminders, events]
}
